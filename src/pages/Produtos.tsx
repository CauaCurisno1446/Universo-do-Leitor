    ...
    <section className="w-full h-auto bg-white">
      <div className="w-full h-[300px] grid grid-cols-2">
        <div className="w-full h-full bg-[var(--marrom)] flex items-center px-12">
          <h1 id="Texto" className="text-[var(--branco)] text-5xl font-bold leading-tight tracking-wider uppercase">
            ENCONTRE O PRODUTO IDEAL PARA VOCÊ.
          </h1>
        </div>
        <div style={{ backgroundImage: `url(${Fundo})` }} className="bg-no-repeat bg-center bg-cover" />
      </div>
