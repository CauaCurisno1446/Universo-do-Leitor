...
function Footer() {
  ...
  return (
    <footer className="bg-[var(--marrom)] text-[var(--branco)] pt-16 pb-8 px-6 flex justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm font-medium">
              <a href="#" className="hover:line-through transition-all decoration-1">
                Lançamentos
              </a>
              <a href="#" className="hover:line-through transition-all decoration-1">
                Clássicos
          ...
          <div className="flex flex-col space-y-4">
            ...
            <nav className="flex flex-col space-y-2 text-sm font-medium">
              <a href="#" className="hover:italic transition-all">
                Instagram
              </a>
              <a href="#" className="hover:italic transition-all">
                Newsletter
